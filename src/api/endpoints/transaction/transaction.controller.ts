...
export class TransactionController {
    ...
    async createTransaction(req, res, next) {
        try {
            const buyer: IOffer = await Offer.findById(req.body.buyer);
            ...
            await new Transaction({
                ...
                buyerOffer: (buyer as any)._id,
                buyerUser: buyer.user,
                sellerOffer: (seller as any)._id,
